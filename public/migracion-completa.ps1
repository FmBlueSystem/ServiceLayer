...
1️⃣  Transferir archivos del código fuente
   Desde Linux, ejecuta:
   scp -r src/ fmolinam@10.13.0.29:C:/Projects/ServiceLayer/
   scp -r public/ fmolinam@10.13.0.29:C:/Projects/ServiceLayer/
   scp -r database/ fmolinam@10.13.0.29:C:/Projects/ServiceLayer/
   scp -r scripts/ fmolinam@10.13.0.29:C:/Projects/ServiceLayer/
