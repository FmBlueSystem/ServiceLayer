...
Write-Host "   scp -r src/ fmolinam@10.13.0.29:C:/ServiceLayer/" -ForegroundColor Gray
Write-Host "   scp -r public/ fmolinam@10.13.0.29:C:/ServiceLayer/" -ForegroundColor Gray
Write-Host "   scp -r database/ fmolinam@10.13.0.29:C:/ServiceLayer/" -ForegroundColor Gray
Write-Host "   scp -r scripts/ fmolinam@10.13.0.29:C:/ServiceLayer/" -ForegroundColor Gray
Write-Host "   scp package.json fmolinam@10.13.0.29:C:/ServiceLayer/" -ForegroundColor Gray
Write-Host ""
