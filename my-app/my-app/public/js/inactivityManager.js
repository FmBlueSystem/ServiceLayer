...
(function() {
    ...
    const InactivityManager = {
        config: {
            // Tiempo de inactividad antes de logout (15 minutos)
            inactivityTimeout: 15 * 60 * 1000, // 15 minutos en ms

            // Tiempo para mostrar advertencia antes del logout (13 minutos)
            warningTimeout: 13 * 60 * 1000, // 13 minutos en ms

            // URL de redirección al hacer logout
            loginUrl: '/login-simple.html',
